...
import featured from "../../assets/rabbit-assets-main/assets/featured.webp";

const FeaturedCollection =() =>{
    return <section className="py-16 px-4 lg:px-0">
        <div className="container mx-auto flex flex-xol-reverse lg:flex-row items-center bg-green-50 rounded-3xl">
            {/* Left Content */}
            <div className="lg:w-1/2 p-8 text-center lg:text-left">
            <h2 className="text-lg font-serif font-bold text-gray-700 mb-2">
                Comfort and Style
            </h2>
